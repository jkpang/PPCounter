...
/**
 在1.5s内,一般字体属性UILabel中的数字从 0 -> number
...
/**
 在1.5s内,富文本字体属性UILabel中的数字从 0 -> number
...
/**
 在1.5s内,一般字体属性UILabel中的数字从 numberA -> numberB
...
/**
 在1.5s内,富文本字体属性UILabel中的数字从 numberA -> numberB
...
/**
 在指定时间内,一般字体属性UILabel中的数字从 numberA -> numberB,
...
/**
 在指定时间内,富文本字体属性UILabel中的数字从 numberA -> numberB,
